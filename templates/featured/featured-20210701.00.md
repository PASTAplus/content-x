...
<div class="figure_featured" style="width: 50%;">
    <figure>
       <img src="/static/images/featured_data/nutnet-map.png" alt="map of participating grassland sites"/>
       <figcaption class="figure-caption">Fig. 1: Participating grassland sites in the Nutrient Network – a global research cooperative (credit: [nutnet.org](https://nutnet.org/)).</figcaption>
    </figure>
</div>
...
<div class="figure_featured" style="width: 50%;">
    <figure>
       <img id="pickme" src="/static/images/featured_data/bogong-researcher.jpg" alt="researcher working in a grassland site"/>
       <figcaption class="figure-caption">Fig. 2: A researcher at the subalpine Bogong site in Australia, sampling in a fenced plot (photo credit: [nutnet.org](https://nutnet.org/))</figcaption>
    </figure>
</div>
