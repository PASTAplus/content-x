...
<img src="/static/images/data-package-versioning.png" width="35%">
...
It is important to communicate changes and significance in the metadata of an updated data package so users can understand what has changed and why. This information is included in the [maintenance](https://ediorg.github.io/data-package-best-practices/guide-eml-bp/content-recommendations.html#maintenance) section of EML metadata. Guidance on adding this information is provided below.
...
<img class="screen-shot" src="/static/images/allow-pasta-update.png" width="70%">
