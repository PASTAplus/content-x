...
EDI recognizes two publication pathways: 1) curator supported (see Steps 1-4 below) and 2) self-publication. Self-publication means that EDI grants you, the contributor, the privilege to publish data in the EDI data repository without direct oversight by an EDI curator. Privilege is applied through the EDI Identity and Access Management system. With this privilege comes additional responsibility to ensure both the data and metadata are of the highest quality. If you have never published a data package before with EDI, you are required to work with the EDI Data Curation Team for at least your first data publication before being permitted to self-publish. To learn about self-publishing see [Self-Publishing](/templates/resources/self-publishing.md).
